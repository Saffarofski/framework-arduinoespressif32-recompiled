...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "esp_diag_data_store", "src", "rtc_store"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "esp_diag_data_store", "include"),
    ...
    CPPDEFINES=[
        ...
        "WITH_POSIX",
        "_GNU_SOURCE",
        ("IDF_VER", '\\"v4.4.5-314-g5f0ac58e1b\\"'),
        "ESP_PLATFORM",
